...
export const environment = {
  ...
  urls: {
    ...
    targetAddGenesUrl: 'api/v1/absci-targets/gene-registration/',
    ...
    partsUrl: 'api/v1/absci-targets/parts-view/',
    sequencePropertiesUrl: 'api/v1/absci-targets/biophysical-properties-view/',
